...
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES ('clientapp', 'restservice', '123456', 'read,write', 'password,refresh_token', '/success', 'USER,GUEST,ADMIN', 1000000, 10000, null, null);
INSERT INTO clientdetails (appid, resourceids, appsecret, scope, granttypes, redirecturl, authorities, access_token_validity, refresh_token_validity, additionalinformation, autoapprovescopes) VALUES ('clientapp', 'restservice', '123456', 'read,write', 'password,refresh_token', '/success', 'USER', 1001000, 10000, '', null);
